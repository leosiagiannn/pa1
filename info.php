    ...
    <section class="courses-section spad">
        <div class="container">
            <div class="section-title text-center">
                ...
                <p>Berikut tertera informasi atau berita terbaru mengenai DEL UI/UX Club</p>
            </div>
            ...
            <div class="" col-md-8>
                <div class="table-responsive">
                    ...
                    <table style="width:100%;text-align:center; color: black"
                        ...
                        <?php foreach ($DaftarNotif as $info) { ?>
                        <tr>
                            <td><?= ++$nomor ?></td>
                            <td><?= $info['judul'] ?></td>
                            ...
                            <td>
                                <a data-toggle="modal" class="badge badge-success float-right ml-1"
                                    href="#edit_<?php echo $info['id_informasi']; ?>">
                                    <i class="fa fa-edit">&nbsp Ubah</i></a>&nbsp &nbsp
                                <a data-toggle="modal" class="badge badge-success float-right ml-1"
                                    href="#delete_<?php echo $info['id_informasi']; ?>">
