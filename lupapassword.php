	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/form.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form class="login100-form validate-form p-b-33 p-t-5" method="POST" action="lupapasswordprocess.php">
					...
					<center><p>Sudah punya akun?<a href="index.php" >Masuk disini</a> </p></center>
